#' Unmixing OLS, standard solution
#'
#' Take the spectral signature M and unmix the full-stained sample via closed-form solution of OLS.
#'
...
#' @export
unmix_OLS <- function(M,fs_raw, aurora_channel_change = FALSE, channels = NULL, plot = TRUE){
